...
async function runHomeEmailCardResponsiveTests() {
  ...
  assert(homeContent.includes('support@mobiletechnologystation.com.np'), "Home page contains complete official email 'support@mobiletechnologystation.com.np'");
  assert(homeContent.includes('href="mailto:support@mobiletechnologystation.com.np"'), "Email is an interactive clickable mailto link");
