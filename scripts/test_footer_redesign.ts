...
async function runTests() {
  ...
  const serverPath = fs.existsSync(path.join(process.cwd(), 'src/server/app.ts'))
  ...
  // Customer Support
  assert(footerContent.includes('support@mobiletechnologystation.com.np'), 'Support Email: support@mobiletechnologystation.com.np');
  assert(footerContent.includes('mailto:support@mobiletechnologystation.com.np'), 'Mailto link for Support Email');
