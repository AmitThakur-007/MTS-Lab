...
async function runFooterTermsPrivacyNavigationTests() {
  ...
  assert(termsContent.includes('support@mobiletechnologystation.com.np'), "Terms page includes official support email");
  ...
  assert(privacyContent.includes('support@mobiletechnologystation.com.np'), "Privacy page includes official privacy email");
