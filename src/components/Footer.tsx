            ...
            <div className="space-y-2.5 text-xs sm:text-sm text-slate-400">
              <div className="flex items-start gap-2.5">
                ...
                <div>
                  ...
                  <a href="mailto:support@mobiletechnologystation.com.np" className="text-slate-300 hover:text-indigo-400 transition-colors font-medium break-all underline decoration-slate-800 underline-offset-4">
