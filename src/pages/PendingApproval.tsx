...
export default function PendingApproval() {
  ...
  }, [email, deviceIdentifier, navigate, setAuth]);

  // Instant notification via Supabase Realtime when Super Admin reviews request
  useRealtimeSync(['accessrequest', 'approveddevice', 'user', 'session'], () => {
    checkStatus(true);
  });
  ...
  useEffect(() => {
    ...
    // Gentle fallback interval running only when tab is visible
